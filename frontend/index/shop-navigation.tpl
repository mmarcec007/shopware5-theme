    ...
    <ul class="navigation--list block-group" role="menubar">
        ...
        {block name='frontend_index_search'}
            <li class="navigation--entry entry--search" role="menuitem" data-search="true" aria-haspopup="true"{if $theme.focusSearch && {controllerName|lower} == 'index'} data-activeOnStart="true"{/if}>
                <a class="btn entry--link entry--trigger" href="#show-hide--search" title="{"{s namespace='../themes/Frontend/TestTheme/_private/snippets/frontend/index/search' name="IndexTitleSearchToggle"}{/s}"|escape}">
                    <i class="icon--search"></i>

                    {block name='frontend_index_search_display'}
                        <span class="search--display">{s namespace='../themes/Frontend/TestTheme/_private/snippets/frontend/index/search' name="IndexSearchFieldSubmit"}{/s}</span>
                    {/block}
                </a>
